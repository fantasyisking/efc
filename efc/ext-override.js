...
/*Ext.override(Ext.Window, {
	 设置Ext.Window缺省需要iframe层用于防止activex控件遮盖 
	iframeMask : true,
 ...
 * 重写Field控件属性
 */
Ext.form.Field.prototype.initComponent = Ext.form.Field.prototype.initComponent.createInterceptor(function() {
